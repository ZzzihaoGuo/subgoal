...
from dgppo.trainer.trainer_subgoal_manifold_vmas import Trainer
from dgppo.trainer.utils import is_connected


def train(args):
    print(f"> Running train_try_manifold_vmas.py {args}")
    ...
    # 2. 预热 manifold
    print("Warming up VMAS manifold controller (first JIT compile)...")
    ...
    print("VMAS manifold warmup complete!")
    # ====================================================
...
def main():
    ...
    # required arguments
    parser.add_argument("--env", type=str, default="VMASReverseTransport")
    ...
    parser.add_argument("--max-step", type=int, default=64)

    args = parser.parse_args()

    # Auto-compute batch_size
